...
Path = 'C:\Users\AJIN RUFUS\Documents\My Files\CE678a\Project Work 1\saral_data'; % wherever you want to search
...
%% Parsing ascensing and descending pass
...
file_name = {'\0*\0*_0051ssh.33.nc';'\0*\0*_0066ssh.33.nc';'\0*\0*_0137ssh.33.nc';'\0*\0*_0223ssh.33.nc';'\0*\0*_0266ssh.33.nc';'\0*\0*_0337ssh.33.nc';'\0*\0*_0352ssh.33.nc';'\0*\0*_0438ssh.33.nc';'\0*\0*_0509ssh.33.nc';'\0*\0*_0524ssh.33.nc';'\0*\0*_0595ssh.33.nc';'\0*\0*_0681ssh.33.nc';'\0*\0*_0724ssh.33.nc';'\0*\0*_0795ssh.33.nc';'\0*\0*_0881ssh.33.nc';'\0*\0*_0896ssh.33.nc';'\0*\0*_0967ssh.33.nc';'\0*\0*_0982ssh.33.nc'}; % file name of each pass
...
for i = 1:width(R_mean)
        ...
        xlabel('longitude')
        ylabel('Latitude')
        title('Descending Tracks','FontWeight','bold')
...
for i = 1: length(lat_pass)
    for j = 1:length(lat_pass{i})-1
        ...
        slope_descend{j,i} = -(height_var{j,i}./c{j,i}); % descending track slope that is the DOV 
